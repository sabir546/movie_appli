        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12">
          {currentMovies.map((movie) => (
            <Link key={movie.id} to={`/movie/${movie.id}`} className="group">
              <div
                className="relative overflow-hidden rounded-md shadow-md bg-zinc-500 hover:shadow-lg transition duration-300 transform hover:scale-105 text-white"
              ...
              >
                ...
                <div className="p-4 text-white">
                  ...
                  <p className="text-sm mb-1 flex text-white items-center justify-center">
